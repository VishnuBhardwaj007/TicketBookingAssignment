...
namespace Task_8_Interfaces_Abstrac__classes.Model
{
    internal class Event
    {
        ...
        public Event(string eventName, DateTime dateTime, TimeSpan timeSpan, int totalSeats, decimal ticketPrice, string eventType, Venue venu)
        {
            EventName = eventName;
        ...
        public Event(string eventName, DateTime dateTime, TimeSpan timeSpan, int totalSeats, decimal ticketPrice, string eventType, string venueName)
        {
            EventName = eventName;
            this.dateTime = dateTime;
            this.timeSpan = timeSpan;
